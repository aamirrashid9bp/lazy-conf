...
export default function LeadCaptureModal() {
  ...
  return (
    <div className="fixed inset-0 z-[99999] flex items-center justify-center p-4 sm:p-6 overflow-y-auto">
      ...
      {/* Modal Dialog Card */}
      <div className="relative z-10 w-full max-w-2xl max-h-[92vh] flex flex-col bg-[#090b0a] border border-white/15 rounded-[4px] shadow-[0_0_50px_rgba(0,0,0,0.8)] overflow-hidden my-auto animate-modalEntry">
        ...
        {/* Dynamic Form Content (internally scrollable when needed) */}
        <div className="px-4 sm:px-6 pb-6 pt-2 overflow-y-auto flex-1">
